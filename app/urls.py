...
from bookstore.views import single_book
from bookstore.views import add_review
from bookstore.views import edit_review
from bookstore.views import delete_review
from bookstore.views import add_comment
from bookstore.views import edit_comment
from bookstore.views import delete_comment
...
urlpatterns = [
    ...
    path('book/<slug:single_book_slug>', single_book, name="single_book"),
    path('book/<slug:book_slug>/add-review/', add_review, name='add_review'),
    path('book/<slug:book_slug>/edit-review/<uuid:review_id>/', edit_review, name='edit_review'),
    path('book/<slug:book_slug>/delete-review/<uuid:review_id>/', delete_review, name='delete_review'),
    path('book/<slug:book_slug>/add-comment/', add_comment, name='add_comment'),
    path('book/<slug:book_slug>/edit-comment/<uuid:comment_id>/', edit_comment, name='edit_comment'),
    path('book/<slug:book_slug>/delete-comment/<uuid:comment_id>/', delete_comment, name='delete_comment'),
